...
val studentList = arrayListOf<Student>()
    ...
    fun addStudent(v: View) {
        ...
        mDialogView.btnAdd.setOnClickListener{
            studentList.add( Student(mDialogView.edt_age.text.toString(), mDialogView.edt_name.text.toString(),
    ...
    fun testStudentData(){
        studentList.add(Student("603021064-3","Adisorn Hirancha",20))
        studentList.add(Student("603020795-9","Paksirinya Somparn",20))
    }
}
